...
4. execute 'java -jar target/scala-2.13/dirtscrapper.jar 999' where 999 is your club id (if you don't know it open your club page and check in the url the number after /club/)
